  ...
  route 'inventory', 'masterfiles' do |r|
    ...
    r.on 'rmt_container_material_types', Integer do |id|
      ...
      r.on 'edit' do   # EDIT
        check_auth!('inventory', 'edit')
        interactor.assert_permission!(:edit, id)
        show_partial { Masterfiles::Inventory::RmtContainerMaterialType::Edit.call(id) }
      end
      ...
      #     check_auth!('inventory', 'edit')
      #     interactor.assert_permission!(:complete, id)
      #     show_partial { Masterfiles::Inventory::RmtContainerMaterialType::Complete.call(id) }
      #   end
      ...
      #       redirect_to_last_grid(r)
      #     else
      #       re_show_form(r, res) { Masterfiles::Inventory::RmtContainerMaterialType::Complete.call(id, params[:rmt_container_material_type], res.errors) }
      #     end
      #   end
      # end
      ...
      #     check_auth!('inventory', 'approve')
      #     interactor.assert_permission!(:approve, id)
      #     show_partial { Masterfiles::Inventory::RmtContainerMaterialType::Approve.call(id) }
      #   end
      ...
      #       redirect_to_last_grid(r)
      #     else
      #       re_show_form(r, res) { Masterfiles::Inventory::RmtContainerMaterialType::Approve.call(id, params[:rmt_container_material_type], res.errors) }
      #     end
      #   end
      # end
      ...
      #     check_auth!('inventory', 'edit')
      #     interactor.assert_permission!(:reopen, id)
      #     show_partial { Masterfiles::Inventory::RmtContainerMaterialType::Reopen.call(id) }
      #   end
      ...
      #       redirect_to_last_grid(r)
      #     else
      #       re_show_form(r, res) { Masterfiles::Inventory::RmtContainerMaterialType::Reopen.call(id, params[:rmt_container_material_type], res.errors) }
      #     end
      #   end
      # end
      ...
      r.is do
        r.get do       # SHOW
          check_auth!('inventory', 'read')
          show_partial { Masterfiles::Inventory::RmtContainerMaterialType::Show.call(id) }
        end
        r.patch do     # UPDATE
          res = interactor.update_rmt_container_material_type(id, params[:rmt_container_material_type])
          if res.success
            update_grid_row(id, changes: { container_material_type_code: res.instance[:container_material_type_code], rmt_container_type_id: res.instance[:rmt_container_type_id] },
                            notice: res.message)
          else
            re_show_form(r, res) { Masterfiles::Inventory::RmtContainerMaterialType::Edit.call(id, form_values: params[:rmt_container_material_type], form_errors: res.errors) }
          end
        end
        r.delete do    # DELETE
          check_auth!('inventory', 'delete')
    ...
    r.on 'rmt_container_material_types' do
      ...
      r.on 'new' do    # NEW
        check_auth!('inventory', 'new')
        show_partial_or_page(r) { Masterfiles::Inventory::RmtContainerMaterialType::New.call(remote: fetch?(r)) }
      end
      r.post do        # CREATE
        ...
        if res.success
          ...
          re_show_form(r, res, url: '/masterfiles/inventory/rmt_container_material_types/new') do
            Masterfiles::Inventory::RmtContainerMaterialType::New.call(form_values: params[:rmt_container_material_type],
                                                                       form_errors: res.errors,
                                                                       remote: fetch?(r))
          end
        end
