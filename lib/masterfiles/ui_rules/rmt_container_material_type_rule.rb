...
module UiRules
  class RmtContainerMaterialTypeRule < Base
    ...
    def common_fields
      {
        ...
        rmt_container_type_id: { renderer: :select, options: MasterfilesApp::RmtContainerTypeRepo.new.for_select_rmt_container_types, disabled_options: MasterfilesApp::RmtContainerTypeRepo.new.for_select_rmt_container_types, caption: 'rmt_container_type', required: true }
      }
    end
    ...
    def make_new_form_object
      @form_object = OpenStruct.new(container_material_type_code: nil,
